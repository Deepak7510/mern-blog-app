...
const SearchBlogTile = ({ blogDetails, setOpenSearchListSheet }) => {
  ...
  function navigateHandler() {
    setOpenSearchListSheet(false);
    naviagte(RouteUserBlogDetails(blogDetails.category.slug, blogDetails.slug));
  }

  const formattedDate = format(new Date(blogDetails?.createdAt), "dd-MM-yyyy");
  return (
    <div onClick={navigateHandler} className="flex mb-4 gap-4 cursor-pointer">
