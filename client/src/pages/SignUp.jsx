...
import AuthWithGoolge from '@/components/common/AuthWithGoolge'
    ...
    return (
        <div className=' flex justify-center items-center h-screen w-screen'>
            ...
            <Card className='w-[400px] m-2'>
                <CardTitle className={'font-extrabold text-2xl text-center'}>Create your Account</CardTitle>
                <CardContent>
                    <AuthWithGoolge />
                    <Form {...form} >
                        <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-2' >
                            ...
                            <div>
                                <Button disabled={form.formState.isSubmitting} className={'w-full'} type="submit">Sign Up</Button>
