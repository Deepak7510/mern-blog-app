...
import CommentsTableRow from "@/components/admin/CommentsTableRow";
import CommentsTableRowLoading from "@/components/admin/CommentsTableRowLoading";

const AdminManageCommentPage = () => {
  const { getData, data, loading } = useFetch(
    `${import.meta.env.VITE_BACKEND_URL}/api/comment/fetch`,
    {},
    []
  );
